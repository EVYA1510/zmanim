...
/**
 * Given a JavaScript Date, return the Parasha name
 * for that Hebrew year when it's one of the special
 * leap‐year cases (5771 or 5774).
 */
export function getParashaSpecial(jsDate) {
  // 1. Wrap in an HDate to get Hebrew fields + rd (Rata Die)
